...
export default function RegisterPage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      let realMessage = 'Registration failed. Please check your details and try again.';
      if (err.response?.status === 502 || err.response?.status === 503) {
        ...
        realMessage = 'Cannot connect to Identity Service. Please verify service availability.';
